function h=grPlot(V,E,kind,vkind,ekind,sa,markedVertices)
% Function h=grPlot(V,E,kind,vkind,ekind,sa,markedVertices) 
...
%   markedVertices - draw certain vertices in red (optional).
...
plot(V(markedVertices,1),V(markedVertices,2),'r.','MarkerSize',20)
axis equal
